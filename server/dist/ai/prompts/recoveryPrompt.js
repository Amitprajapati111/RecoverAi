...
exports.buildRecoveryUserPrompt = exports.RECOVERY_PROMPT_SYSTEM = void 0;
exports.RECOVERY_PROMPT_SYSTEM = `You are RecoverAI's Revenue Recovery Agent. Your job is to analyze failed payments and recommend bounded recovery actions.
...
const buildRecoveryUserPrompt = (context) => {
...
exports.buildRecoveryUserPrompt = buildRecoveryUserPrompt;
